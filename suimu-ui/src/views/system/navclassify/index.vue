<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="1=分类，2=标签" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择1=分类，2=标签" clearable size="small">
          <el-option
            v-for="dict in dict.type.nav_classify_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:navclassify:add']"
        >新增</el-button>
      </el-col>
    ...
    >
      ...
      <el-table-column label="1=分类，2=标签" align="center" prop="type">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['system:navclassify:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
          ...
          <el-button
            ...
            v-hasPermi="['system:navclassify:remove']"
          >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="1=分类，2=标签" prop="type">
          <el-select v-model="form.type" placeholder="请选择1=分类，2=标签">
            <el-option
              v-for="dict in dict.type.nav_classify_type"
              :key="dict.value"
              :label="dict.label"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        type: [
          { required: true, message: "1=分类，2=标签不能为空", trigger: "change" }
        ],
        sort: [
